...
async function main() {
  const Whitelisted = await ethers.getContractFactory("Whitelist")
  const whitelisted = await Whitelisted.deploy(20)
  await whitelisted.deployed()

  console.log("Whitelist Contract deployed to: " + whitelisted.address)
}
